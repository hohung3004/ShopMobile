	...
	<div class="container-fluid pt-4 px-4">
				<div class="bg-secondary text-center rounded p-4">
					<div class="d-flex align-items-center justify-content-between mb-4">
						<h6 class="mb-0">Insert Products</h6>
						<a href="loadProducts"><button class="fa fa-undo me-2"></button></a>
					</div>
					<h3 style="color:red">${err }</h3>
					<div class="table-responsive">
					<form:form action="insertProducts" method="post" modelAttribute="p" enctype="multipart/form-data" >
						<table
							class="table text-start align-middle table-bordered table-hover mb-0">
								...
								<tr class="text-white">
									...
									<td><input type="file" name="productImage1Source" /></td>
								</tr>
								<tr class="text-white">
									<td>Product Image2: </td>
									<td><input type="file" name="productImage2Source" /></td>
								</tr>
								<tr class="text-white">
									<td>Product Image3: </td>
									<td><input type="file" name="productImage3Source" /></td>
								</tr>   
								<tr class="text-white">
									<td></td>
