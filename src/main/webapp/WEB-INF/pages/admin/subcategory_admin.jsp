	...
	<div class="container-fluid position-relative d-flex p-0">
		...
		<div class="content">
			...
			<nav
				...
				<form action="searchSubcategoryByName" class="d-none d-md-flex ms-4">
			...
			<div class="container-fluid pt-4 px-4">
				<div class="bg-secondary text-center rounded p-4">
					<div class="d-flex align-items-center justify-content-between mb-4">
						<h6 class="mb-0">List Subcategory</h6>
						<a href="initInsertSubcategory"><button class="fa fa-plus me-2"></button></a>
					</div>
							...
							<tbody>
								<c:forEach items="${list }" var="s">
									<tr>
										...
										<td><a href="detailSubcategory?id=${s.id }"><button class="fa fa-eye me-2"></button></a>
											<a href="initUpdateSubcategory?id=${s.id }"><button class="fa fa-edit me-2"></button></a>
											<a href="deleteSubcategory?id=${s.id }" onclick="return confirm('Sure?')"><button class="fa fa-trash me-2"></button></a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
