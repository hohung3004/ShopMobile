 ...
 <!--================ Feature Product Area =================-->
  <section class="feature_product_area section_gap_bottom_custom">
    <div class="container">
      ...
      <c:forEach items="${list }" var="s">
       <c:if test="${s.productPrice > 28000000}">
        <div class="col-lg-3 col-md-6">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 mt-5 mt-lg-0">
          <div class="row">
          <c:forEach  items="${listh1 }" var="s">
          <c:if test="${s.productPrice <8000000}">
            <div class="col-lg-3 col-md-6">
              <div class="single-product">
                <div class="product-img">
                  <img  src="<c:url value="resources/them1"/>/img/${s.productImage1}" height="250px" width="250px" alt="" />
  ...
  <section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
      ...
      <div class="row">
      <c:forEach items="${listh2 }" var="s">
       <c:if test="${s.productPrice <13900000}">
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            <div class="product-img">
              <img  src="<c:url value="resources/them1"/>/img/${s.productImage1}" height="250px" width="250px" alt="" />
